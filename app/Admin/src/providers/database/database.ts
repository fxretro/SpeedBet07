...
export class DatabaseProvider {
  ...
  updateSettings(key_: string, stopped, bet,delay, delay_start, delay_end, move_down_bet, move_right_bet){  
    ...
    let uid = this.authProvider.currentUserUid()    
    let path = "/configs/" + uid + "/"
    return this.db.list(path).update(key_, {stopped: stopped, bet: bet, delay: delay, delay_start: delay_start,delay_end: delay_end, move_down_bet: move_down_bet, move_right_bet: move_right_bet } )   
  }   
